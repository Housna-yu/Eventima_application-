...
import 'package:flutter_application_1/screens/photographers_services_screens/Services.dart';
import 'package:flutter_application_1/screens/photographers_services_screens/photographers_requests_form.dart';
    ...
    return Scaffold(
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            Text(
              'Welcome to photographers Services!',
              style: TextStyle(
                fontSize: 28,
            ...
            SizedBox(height: 16),
            Text(
              'Explore our services and manage your photography requests with ease.',
        ...
        children: [
          ...
          _buildDrawerItem(context,
            ...
            Navigator.pushReplacement(
              ...
              MaterialPageRoute(
                  builder: (context) =>
                      PhotographerRequestForm(serviceProviderId: '')),
            );
          }),
          _buildDrawerItem(context,
            ...
            Navigator.pushReplacement(
              context,
              MaterialPageRoute(builder: (context) => PhotographersServices()),
            );
          }),
