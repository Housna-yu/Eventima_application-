...
class MyphotographyRequestsUI extends StatelessWidget {
  final Map<String, dynamic> user = {
    'first_name': 'aya',
    'last_name': 'Yousif saeed',
    'email': 'aya120@gmail.com',
    'company_name': 'aya ',
    ...
    'requests': [
      {
        ...
        'description': 'womens occasions services',
        'gender': 'female',
        'location': 'Uptown',
        'price': '\$1000 per night',
        'status': 'pending',
        'Number of staff': '5 pgotgraphers ',
        'facebook': 'Dora Joy',
        'instagram': 'Dora Joy',
        'X': 'Dora Joy',
        'images': ['assets/photographer3.jpg'],
      },
    ],
  };
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('My photography Requests',
