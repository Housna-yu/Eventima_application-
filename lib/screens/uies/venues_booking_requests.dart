...
class VenuesBookingRequestsUI extends StatelessWidget {
  final List<Map<String, dynamic>> users = [
    {
      ...
      'requests': [
        {
          'Date/time': '24/6/2025, 2 PM - 5 PM',
          'email': 'contact@DoraJoy.com',
          'Phone number': '0865446',
          'location': 'Ciro,Egypt',
          'status': 'Accepted',
          'Number of gusest/seats': '120 guests',
          'More Details':
              'make sure everthing is clean and organized', // Gender is not provided
        },
      ],
    },
    {
      ...
      'requests': [
        {
          'Date/time': '25/5/2025 / 6 PM - 10 PM',
          'email': 'amira120@gmail.com',
          'Phone number': '011865446',
          'location': 'ciro/egypt/elharam',
          'status': 'rejected',
          'Number of gusest/seats': '120 guests / 150 seats ',
          'More Details': '__',
        },
      ],
    },
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Venues booking requests',
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(' Email: ${request['email']}',
                            style: TextStyle(fontSize: 16)),
                        Text(
                            'Number of gusest/seats: ${request['Number of gusest/seats']}',
                            style: TextStyle(fontSize: 16)),
