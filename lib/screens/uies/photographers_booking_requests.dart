...
class PhotographersBookingRequestsUI extends StatelessWidget {
      ...
      'requests': [
        {
          ...
          'location': 'Ciro,Egypt',
          'status': 'rejected',
          'Gender/number of photgraphers': '3 females',
      ...
      'requests': [
        {
          ...
          'status': 'pending',
          'Gender/number of photgraphers': '2 males',
          'More Details':
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('photographers booking requests',
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(' Email: ${request['email']}',
                            style: TextStyle(fontSize: 16)),
                        Text(
                            'Gender/number of photgraphers: ${request['Gender/number of photgraphers']}',
                            style: TextStyle(fontSize: 16)),
