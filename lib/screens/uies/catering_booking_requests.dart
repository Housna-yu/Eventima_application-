...
class CateringBookingRequestsUI extends StatelessWidget {
      ...
      'requests': [
        {
          ...
          'location': 'Ciro,Egypt',
          'status': 'Acepted',
          'food category / number of dishes':
              '55 chicken dishes with apatizers',
      ...
      'requests': [
        {
          ...
          'status': 'pending',
          'food category / number of dishes':
              '120 dishes of Mixed meats with salads and some appetizers',
          'More Details':
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('catering booking requests',
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(' Email: ${request['email']}',
                            style: TextStyle(fontSize: 16)),
                        Text(
                            'food category / number of dishes: ${request['food category / number of dishes']}',
                            style: TextStyle(fontSize: 16)),
