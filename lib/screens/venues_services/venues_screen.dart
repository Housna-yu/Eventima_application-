...
import 'package:flutter_application_1/screens/venues_services/venues_request_form.dart';
...
class VenuesScreen extends StatelessWidget {
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            SizedBox(height: 16),
            Text(
              'Explore our services and manage your venues requests with ease.',
        ...
        children: [
          ...
          _buildDrawerItem(context,
            ...
            Navigator.pushReplacement(
              context,
              MaterialPageRoute(
                  builder: (context) => VenuesRequestForm(
                        serviceProviderId: '',
                      )),
            );
          }),
  ...
  String _getDescriptionForIndex(int index) {
    switch (index) {
      case 0:
        return 'Submit your venue requests.';
      case 1:
