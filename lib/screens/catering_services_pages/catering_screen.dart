...
class CateringScreen extends StatelessWidget {
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            SizedBox(height: 16),
            Text(
              'Explore our services and manage your catering requests with ease.',
        ...
        children: [
          ...
          _buildDrawerItem(context,
            ...
            Navigator.pushReplacement(
              ...
              MaterialPageRoute(
                  builder: (context) =>
                      CateringRequestForm(serviceProviderid: '')),
            );
          }),
          _buildDrawerItem(context,
  ...
  String _getDescriptionForIndex(int index) {
    switch (index) {
      case 0:
        return 'Submit your catering requests.';
      case 1:
        return 'Browse available catering services.';
      case 2:
